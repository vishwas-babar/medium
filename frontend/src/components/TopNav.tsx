...
const TopNav = () => {
    return (
        <div className='w-full fixed top-0 left-0 right-0 h-16 flex justify-between bg-gray-200'>
            <Link to={'/'} className=' h-full flex items-center justify-center ml-10 text-xl cursor-pointer font-semibold uppercase'>
                <MediumLogo />
            </Link>

            <div className='h-full mr-10 flex gap-7 items-center'>
  
                <Link to={'/publish'}>
                    <button type='button' className='px-5 text-[16px] text-white cursor-pointer py-2 flex items-center justify-center bg-green-700 rounded-3xl'>
                        <p>New</p>
                    </button>
                </Link>

                <div>
                    <Avatar className='scale-150 hover:cursor-pointer' name='Vishwas Babar' />
                </div>
            </div>
        </div>
    )
